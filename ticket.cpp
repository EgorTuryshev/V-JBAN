...
Ticket::Ticket(const QString& name, const QStringList& people,
    ...
    : m_name(name), m_id(id), m_people(people), m_priority(priority), m_difficulty(difficulty), m_startDate(startDate), m_endDate(endDate), m_chat(chat), m_description(description) {};
